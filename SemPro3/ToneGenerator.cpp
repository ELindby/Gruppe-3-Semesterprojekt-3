...
ToneGenerator::ToneGenerator(int lowDTMFL, int lowDTMFU, int highDTMFL, int highDTMFU) {
	PlaySound(lowDTMFL, lowDTMFU, highDTMFL, highDTMFU);
}

void ToneGenerator::PlaySound(int lowDTMFL, int lowDTMFU, int highDTMFL, int highDTMFU) {
	// Sample sinewave
